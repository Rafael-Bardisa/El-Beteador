...
from core.interfaces.inner.driver_manager import DriverManagerInterface, typeWebDriver
...
class DriverManager(DriverManagerInterface):
    ...
    def create_driver(self, driver_type: Literal["firefox", "chrome", "safari", "edge"]) -> typeWebDriver:
        assert driver_type in ["firefox", "chrome", "safari", "edge"], \
            'Driver must be one of ["firefox", "chrome", "safari", "edge"]'
